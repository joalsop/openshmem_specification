...
Atomic Memory Operation
    & \begin{BVerbatim}
shmem_atomic_fetch_inc_nbi(dest, pe):
  R1 = LD dest, pe
  R2 = R1 + 1
  ST R2 -> dest, pe
  ST R1 -> fetch, my_pe
...
Atomic Memory Operation
    & \begin{BVerbatim}
shmem_atomic_fetch_add_nbi(dest, value, pe):
  R1 = LD dest, pe
  R2 = R1 + value
  ST R2 -> dest, pe
  ST R1 -> fetch, my_pe
...
Atomic Memory Operation
    & \begin{BVerbatim}
shmem_atomic_fetch_and_nbi(dest, value, pe):
  R1 = LD dest, pe
  R2 = R1 & value
  ST R2 -> dest
  ST R1 -> fetch, my_pe
...
Atomic Memory Operation
    & \begin{BVerbatim}
shmem_atomic_fetch_or_nbi(dest, value, pe):
  R1 = LD dest, pe
  R2 = R1 | value
  ST R2 -> dest
  ST R1 -> fetch, my_pe
...
Atomic Memory Operation
    & \begin{BVerbatim}
shmem_atomic_fetch_xor_nbi(dest, value, pe):
  R1 = LD dest, pe
  R2 = R1 ^ value
  ST R2 -> dest
  ST R1 -> fetch, my_pe
